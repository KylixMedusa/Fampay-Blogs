...
const Author: React.FC<any> = (props) => {
  //TODO: Current Author and blogs have to fetched from the backend using the id from params
  const currentAuthor = {name:"Topleap", icon_url:"https://fampay.in/blog/content/images/size/w100/2020/11/logo.png"}
    ...
    <div className="author">
      ...
      <section className="top">
        <div className="content">
          <div className="icon">
            <img src={currentAuthor.icon_url?currentAuthor.icon_url:defaultIcon} alt=""/>
          </div>
